...
\date{\textbf{Note:} This research is part of the Ducci Unified Spectral Theory (DUST) framework investigation. The mathematical validation presented herein is directly referenced in \textit{A Calculus of Souls} by the Ducci Brothers (\url{https://amzn.eu/d/a9WXvCS}).\\[1em]\today}
...
All code, data, and reproducibility materials are freely available at \url{https://github.com/Spectral-Theory-STAR/dust-factorization-paper}.
...
\textbf{Reproducibility}: All code, data ($n=100$ trials), GRH validation scripts, quantum chaos analysis, figures, and complete reproducibility materials available at \url{https://github.com/Spectral-Theory-STAR/dust-factorization-paper}. Session: \texttt{entropic\_factorization\_20251203\_200407}. Quantum analysis: \texttt{quantum\_chaos\_analysis\_20251203\_223001}.
